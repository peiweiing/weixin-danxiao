...
Page((_defineProperty(_Page = {
    ...
    // }, 
        ...
        bindPickerChange: function (e) {
            ...
            console.log('picker发送选择改变，携带值value为',e.detail.value);
            // var adata = that.data.alldata[0],idd=adata.id,typid=adata.type_id,typname=adata.type_name,mon=adata.money;
            var adata = that.data.alldata;
            var that =this;
            ...
            var idd= cidd,typid = cov.type_id,typname=cov.type_name,mon=cov.money;
            // console.log(that.data);
            console.log("adata",adata);
            // console.log("cov.id",cov.id);
            // console.log("idd",idd);
            ...
            wx.navigateTo({
                ...
                url: "../fabu/typefabu/typefabu?type_id=" + ind + "&type_name" + typname + "&money=" + mon
            });
        },
