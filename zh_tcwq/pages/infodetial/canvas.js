...
Page({
    ...
    onLoad: function(e) {
        ...
        o.setData({
            ...
            cachetime: "0",
            success: function(t) {
                console.log(t), console.log(t.data + e.qr_code), wx.downloadFile({
                    url: t.data + e.qr_code,
                    success: function(t) {
                        ...
                        o.setData({
                            ...
                            success: function(t) {
                                console.log(t), t.data.tz.details = t.data.tz.details.replace(/[\r\n]/g, ""), "" != t.data.tz.img ? (t.data.tz.img = t.data.tz.img.split(","), 
                                o.setData({
                                    post: t.data.tz
                                }), o.logo()) : (o.setData({
                                    post: t.data.tz
    ...
    save_canvas: function(t) {
        var a = this, e = a.data, o = e.logo, i = e.width, n = e.proportion, s = e.width - 40, l = e.canvas_height, c = wx.createCanvasContext("firstCanvas");
